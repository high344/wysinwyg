...
import wysinwyg.fw.translator.TranslationListener;
...
public class PloverTranslationValidator implements TranslationListener {
	...
	/*
	 * 
	 * public static void main(String[] args) { PloverTranslator trans = new
	 * PloverTranslator(); String[] test = {
	 ...
	 * "Some people call that  ", "{^ \"}fate\".", "I call it ", "{&Cha}",
	 ...
	 * }
	 * 
	 * public PloverTranslator() { this.commandBegin = '{'; this.commandEnd =
	 ...
	 * System.out.println("consume: "+nke.paramString()); if (!nke.isActionKey()
	 * //&& isConsumeEnabled && nke.getKeyCode() != NativeKeyEvent.VC_BACKSPACE
	 * && nke.getKeyCode() != NativeKeyEvent.VC_DELETE && nke.getKeyCode() !=
	 * NativeKeyEvent.VC_ESCAPE && nke.getKeyCode() != NativeKeyEvent.VC_ENTER
	 * && nke.getKeyCode() != NativeKeyEvent.VC_TAB) { return true; } return
	 * false; }
	 */
